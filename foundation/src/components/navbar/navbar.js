		...
		return (
			...
			>
				...
				<Grid item md={1} sm={2} xs={4}>
					<img className="saturate" src="https://static.wixstatic.com/media/ed491c_ce6e670531c04532b5ea9a3e11f84bd0~mv2_d_1250_1250_s_2.png/v1/fill/w_138,h_137,al_c,q_85,usm_0.33_1.00_0.00/logo_opp_czarne2.webp" alt="logo error"></img>
				</Grid>
			</Grid>
		);
	}
